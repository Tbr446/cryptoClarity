  ...
  <div class="main-container">
    ...
    <div class="learn-container">
      ...
      <div class="learn-flexbox learn-item2">
        ...
        <p>
          Historically ${Number(cryptoPrice.btc.b202112) * 10}, investing has
          been a tool used primarily by wealthy asset owners. After the
          invention of the internet, though, investing has been made
          increasingly accessible for everyone. Within the past five years, a
      ...
      <div class="learn-flexbox learn-item3">
        ...
        <p>
          ...
          value of each dollar gradually dropping over time; the rate at which
          the value drops is known as the inflation rate. The typical inflation
          rate is 2-3% per year, meaning that if you have your money sitting a
          piggy bank, it will be worth 2-3% less next year. This concept
      ...
      <div class="learn-flexbox learn-item4">
        ...
        <p>
          ...
          there are many tools that make it possible to invest with minimal
          risk. Investing correctly can lead to massive wealth generation, this
          is made possible through a process called compound interest.
        </p>
      </div>
      ...
      <div class="learn-flexbox learn-item5">
        ...
        <p>
          ...
          would have $5,368,709. The "interest" rate, in this case, would be
          100% because the amount is doubling every day. In a safe investing
